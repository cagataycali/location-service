...
!function(t) {
  var e = function() {
    function t(t) {
      if (this.eventTarget = t.eventTarget, t.customTemplate && (this.customTemplate = t.customTemplate), !this.eventTarget)
      ...
      get: function() {
        ...
        if (n && !this.partOfSeveralChoices) {
          var i = n
            ...
            : "";
          e = "<div class='contains-image'>",
          e += i,
          e += "<span>" + t.Helpers.getInnerTextOfElement(this.el) + "</span>",
          e += "</div>"
        } else
          e = "<div><span>" + t.Helpers.getInnerTextOfElement(this.el) + "</span></div>";
        return e
      },
      enumerable: !0,
      configurable: !0
  ...
  var e = function() {
    ...
    e.prototype.buildTags = function(e) {
      ...
      new Promise(function(t, e) {
        ...
        var e = n.el.classList.contains("one-row")
            ? 52
            : n.el.classList.contains("two-row")
              ? 102
              : 0,
          i = {
            height: e
    ...
    e.prototype.resize = function(e, n) {
      ...
      setTimeout(function() {
        ...
        var n = i.getElements();
        if (n && n.length > 0) {
          for (var o = [], s = [], r = !1, a = 0; a < n.length; a++) {
            var l = n[a];
            l.visible && (l.calcPosition(), i.listWidth += l.positionVector.width, o.push(l.positionVector.x + l.positionVector.width), s.push(l)),
            l.hasImage() && (r = !0)
          }
          var c = i.el.offsetWidth,
            u = i.listWidth > c;
          u && !r
            ? (i.el.classList.add("two-row"), i.listWidth = Math.max(c, Math.round(o[Math.floor(o.length / 2)] + 50)), i.list.style.width = i.listWidth + "px")
            : i.el.classList.add("one-row"),
          setTimeout(function() {
            ...
            c = i.el.offsetWidth,
            u = i.listWidth > c;
            for (var r = n.slice(), a = r.sort(function(t, e) {
              ...
              var s = a[o];
              s.visible
                ? s.tabIndex = 2 + l ++: s.tabIndex = -1
            }
            u
              ? i.el.classList.remove("hide-nav-buttons")
              : i.el.classList.add("hide-nav-buttons"),
            i.elementWidth = c,
            i.listScrollController.resize(i.listWidth, i.elementWidth),
            i.buildTabableRows(),
            i.el.classList.add("resized"),
            i.eventTarget.dispatchEvent(new CustomEvent(t.ControlElementsEvents.ON_RESIZE)),
            e && e()
          }, 0)
        }
      }, 0)
  ...
  var e = function() {
    ...
    t.parseAndGetMultiValueString = function(e) {
      for (var n = "", i = 0; i < e.length; i++) {
        var o = e[i],
          s = e.length > 1 && i == e.length - 2
            ? t.get("user-reponse-and")
            : ", ";
        n += o + (i < e.length - 1
          ? s
          : "")
...
!function(t) {
  var e = function() {
    function e(e) {
      ...
      this._fieldset && this._fieldset.getAttribute("cf-questions") && (this.questions = this._fieldset.getAttribute("cf-questions").split("|")),
  ...
  var e = function() {
    ...
    e.prototype.callInput = function(e) {
      ...
      this.promise = new Promise(function(t, e) {
        ...
        n.isErrorTerminal(e)
          ? n.eventTarget.dispatchEvent(new CustomEvent(t.MicrophoneBridgeEvent.TERMNIAL_ERROR, {
            detail: t.Dictionary.get("microphone-terminal-error") + e
          }))
...
!function(t) {
  var e = function(e) {
    ...
    n.prototype.reactivate = function() {
      ...
      this.microphoneObj && !this.submitButton.typing && (this.submitButton.loading = !0, this.submitButton.typing = !1)
    },
    n.prototype.onFlowStopped = function() {
    ...
    n.prototype.onFlowUpdate = function(t) {
      var n = this;
      e.prototype.onFlowUpdate.call(this, t),
      this.submitButton.loading = !1,
      this.submitButton.typing && (this.submitButton.typing = !1),
      ...
      this.inputElement.setAttribute("type", i
            ...
            if (e.keyCode == t.Dictionary.keyCodes.enter && this.active)
              ...
              if ("select" == s || "checkbox" == s) {
                ...
                "checkbox" == s || r.multipleChoice
                  ? this.active && e.keyCode == t.Dictionary.keyCodes.enter
                    ? this.submitButton.click()
                    : (this.dispatchKeyChange(o, e.keyCode), this.active || (this.resetValue(), this.setFocusOnInput(), this.dispatchKeyChange(o, e.keyCode)))
    ...
    n.prototype.setFocusOnInput = function() {
      t.UserInputElement.preventAutoFocus || this.inputElement.focus()
    },
    n.prototype.onEnterOrSubmitButtonSubmit = function(t) {
      void 0 === t && (t = null),
      this.active && this.controlElements.highlighted
        ? this.controlElements.clickOnHighlighted()
        : this._currentTag
          ? "file" == this._currentTag.type && t
...
!function(t) {
  ...
  var e = function(e) {
    ...
    n.prototype.processResponseAndSetText = function() {
      ...
      return -1 != i.indexOf("contains-image") && this.textEl.classList.add("contains-image"),
      this.textEl.innerHTML = i,
    ...
    n.prototype.checkForEditMode = function() {
      this.isRobotResponse || this.textEl.hasAttribute("thinking") || (this.el.classList.add("can-edit"), this.disabled = !1)
    },
...
!function(t) {
  ...
  var e = function(e) {
    ...
    n.prototype.onUserWantsToEditTag = function(t) {
      ...
      e && (this.currentUserResponse == this.responses[this.responses.length - 1] && this.currentUserResponse.hide(), this.currentUserResponse = e, this.onListUpdate(this.currentUserResponse))
    },
    ...
    n.prototype.createResponse = function(e, n, i) {
      ...
      return this.responses.push(o),
      this.currentResponse = o,
...
!function(cf_1) {
  var ConversationalForm = function() {
    function ConversationalForm(options) {
      ...
      options.microphoneInput && (options.microphoneInput.init && options.microphoneInput.input || (console.warn("userInput is not correctly setup", options.microphoneInput), options.microphoneInput = null)),
    ...
    ConversationalForm.prototype.setupUI = function() {
      ...
      this.chatList = new cf_1.ChatList({eventTarget: this.eventTarget}),
...
function(t, e) {
  "function" == typeof define && define.amd
    ? define(["conversationalform"], function(n) {
      return t.conversationalform = e(n)
    })
    : "object" == typeof module && module.exports
      ? module.exports = t.conversationalform = e(require("conversationalform"))
      : t.conversationalform = e(cf.ConversationalForm)
}(this, function(t) {
  return t || cf.ConversationalForm
});
